...
const services = [
  ...
  },
  {
    ...
    description: 'Interpretación de estudios, análisis de laboratorio y coordinación con especialistas.',
    icon: ScienceIcon,
  },
  {
  ...
  <Box component="section" id="servicios" sx={{ py: { xs: 8, md: 10 }, backgroundColor: 'background.paper' }}>
    <Container maxWidth="lg">
      ...
      <Typography variant="body1" color="text.secondary" textAlign="center" sx={{ maxWidth: 600, mx: 'auto', mb: 6 }}>
        Brindamos una atención integral, cercana y basada en evidencia para acompañarte en todas las etapas de tu cuidado.
      </Typography>
